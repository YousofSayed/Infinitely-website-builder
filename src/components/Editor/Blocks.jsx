          ...
          async (props) => {
            ...
            if (props.done && isArray(props.res.data)) {
              ...
              for (const block of props.res.data) {
                ...
                // const allBlocks = [...editorBlocks, ...blocks];
                // const handledBlocks = handleCustomBlock(allBlocks, editor);
                // //test symbols style by go to home and make style for symbols and go back to sample page and drop symbol to see magic
                // setBlocks((old) => ({
                //   ...handledBlocks,
                // }));
                // blocksRef.current = handledBlocks;
                // sessionStorage.setItem("symbols-cached", "true");
              }
