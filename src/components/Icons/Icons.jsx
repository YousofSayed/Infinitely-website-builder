...
export const Icons = {
  ...
  wordpress: ({ width = 24, height = 24, fill = mainColor }) => (
    <svg
      height={width}
      width={height}
      version="1.1"
  ...
  dropbox: ({ width = 25, height = 25, fill = mainColor }) => (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        {" "}
        <title>dropbox [#158]</title> <desc>Created with Sketch.</desc>{" "}
        <defs> </defs>{" "}
        <g
          id="Page-1"
          stroke="none"
